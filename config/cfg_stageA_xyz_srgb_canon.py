...
dataset = {
    "name": "FiveK_Canon_XYZ_StageA",
    "root": "/data/umihebi0/users/z-hu/AgentRAW/FiveK_Canon",
    "rgb_path": "sRGB_train",   # sRGB 子集
    "raw_path": "xyz_train",    # XYZ 子集 (.npy)
    "rggb_max": 1.0,          # Stage A 用不到，保留字段以兼容
    "black_level": 0,
}

cfg_sample = {
    "output_folder_root": "/data/umihebi0/users/z-hu/AgentRAW/FiveK_Canon/stageA_patches_train",
...
cfg_train = {
    ...
    "max_samples": -1,
    "save_path": "./outputs/",
    "tensorboard_path": "./runs/run_canon_train/",
    "last_n_for_test": 500,
